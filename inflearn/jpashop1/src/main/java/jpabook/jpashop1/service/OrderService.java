...
import jpabook.jpashop1.repository.order.ItemRepository;
import jpabook.jpashop1.repository.order.MemberRepository;
import jpabook.jpashop1.repository.order.OrderRepository;
...
public class OrderService {
    ...
    public List<Order> findOrders(OrderSearch orderSearch){
        return orderRepository.findAllByString(orderSearch); //문제
    }
